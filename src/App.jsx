...
<section id="contact" className="py-24 bg-[#1A1C23] text-white">
  <div className="max-w-4xl mx-auto px-6 text-center">
    ...
    <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
      ...
      {/* Email Box */}
      <a href="mailto:mahmudrnp@gmail.com" className="flex items-center justify-center gap-3 bg-white/5 p-6 rounded-2xl border border-white/10 hover:border-[#C9A227] transition-all group">
        <Mail className="text-[#C9A227]" />
        <span className="font-medium text-white/90">mahmudrnp@gmail.com</span>
      </a>

      {/* Phone Box */}
      <a href="tel:01728606567" className="flex items-center justify-center gap-3 bg-white/5 p-6 rounded-2xl border border-white/10 hover:border-[#C9A227] transition-all group">
        <Phone className="text-[#C9A227]" />
        <span className="font-medium text-white/90">01728606567</span>
      </a>

      {/* WhatsApp Box */}
      <a href="https://wa.me/8801728606567" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-white/5 p-6 rounded-2xl border border-white/10 hover:border-[#25D366] transition-all group">
      ...
      {/* Location Box */}
      <div className="flex items-center justify-center gap-3 bg-white/5 p-6 rounded-2xl border border-white/10">
